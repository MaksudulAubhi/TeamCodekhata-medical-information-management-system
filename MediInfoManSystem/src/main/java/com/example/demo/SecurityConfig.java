...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/**/patientEdit").hasAnyAuthority("Admin")
		.antMatchers("/**/patientProfileView").hasAnyAuthority("Admin","Doctor","Receptionist")
		.antMatchers("/**/patientList").hasAnyAuthority("Admin","Doctor","Receptionist")
		.antMatchers("/**/deletePatient").hasAnyAuthority("Admin")
		
		.antMatchers("/**/wardInfoAdd").hasAnyAuthority("Admin")
		.antMatchers("/**/wardList").hasAnyAuthority("Admin","Receptionist")
